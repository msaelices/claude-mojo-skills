...
To work around this, until the issue is fixed by Anthropic, manually copy or symlink the skill folders into your local Claude Code skills directory as described above.
